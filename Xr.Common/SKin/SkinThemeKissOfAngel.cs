...
namespace Xr.Common
{
    ...
    internal class SkinThemeKissOfAngel:SkinTheme
    {
        ...
        public override void IniSkinTheme()
        {
            ...
            this.BorderColor = Color.FromArgb(198, 85, 171);
            this.InnerBorderColor = Color.FromArgb(227, 227, 227);
            this.OuterBorderColor = Color.FromArgb(174, 3, 123);
            this.DefaultControlColor = new GradientColor(Color.FromArgb(248, 245, 251), Color.FromArgb(205, 205, 205),
                new float[] { 0.0f, 0.15f, 0.05f, 0.2f, 0.6f, 0.8f, 0.85f },
                new float[] { 0f, 0.2f, 0.4f, 0.6f, 0.8f, 0.9f, 1.0f });
            this.HeightLightControlColor = new GradientColor(Color.FromArgb(205, 205, 205), Color.FromArgb(182, 11, 130),
                new float[] { 0.0F, 0.7F, 1.5F }, new float[] { 0.0F, 0.6F, 1F });
            this.FocusedControlColor = new GradientColor(Color.FromArgb(182, 11, 130), Color.FromArgb(205, 205, 205),
                new float[] { 0.2F, 0.6F, 0.8F, 0.4F, 0.2F }, new float[] { 0.0F, 0.3F, 0.6F, 0.8F, 1F });
            this.UselessColor = Color.FromArgb(159, 159, 159);
            this.CaptionColor = new GradientColor(Color.FromArgb(240, 228, 73, 170), Color.FromArgb(1, 228, 73, 170),
                new float[] { 0.0f, 0.15f, 0.05f, 0.2f, 0.6f, 0.8f, 0.85f },
                new float[] { 0f, 0.2f, 0.4f, 0.6f, 0.8f, 0.9f, 1.0f });
