...
namespace Xr.Common.Controls
{
    ...
    public partial class RichEditor : UserControl
    {
        ...
        private Color _BorderColor = Color.Black;//SkinManager.CurrentSkin.BorderColor;

        private Color _HeightLightBolorColor = Color.Black;//SkinManager.CurrentSkin.HeightLightControlColor.First;
