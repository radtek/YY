...
namespace Xr.RtManager.Utils
{
    public class PrintNote
    {
        ...
        public PrintNote(string HospitalName, string DeptName, string ClinicName, string QueueNum, string Name, string WaitingNum, string Time, string TipMsg, string DoctorTip)
        {
        ...
        public bool Print(ref string message)
        {
            try
            {
                ...
                PrintRow srow0 = new PrintRow(0, "-------------------------------------------", new Font("宋体", 10), System.Drawing.Brushes.Black, 2);
                PrintRow srow1 = new PrintRow(1, HospitalName, new Font("宋体", 18), System.Drawing.Brushes.Black, 17);
