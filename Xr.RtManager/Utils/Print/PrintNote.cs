...
namespace Xr.RtManager.Utils
{
    public class PrintNote
    {
        ...
        public bool Print(ref string message)
        {
            try
            {
                PrintRow srow0 = new PrintRow(0, HospitalName, new Font("宋体", 18), System.Drawing.Brushes.Black, -1);
                ...
                PrintRow srow3 = new PrintRow(3, "姓名:" + Name, new Font("宋体", 14), System.Drawing.Brushes.Black, 105);
                        PrintRow srow4 = new PrintRow(4, "-------------------------------------------", new Font("宋体", 10), System.Drawing.Brushes.Black, 135);
                        PrintRow srow5 = new PrintRow(5, "请您到等候休息区等待", new Font("宋体", 16), System.Drawing.Brushes.Green, 145);
                        PrintRow srow6 = new PrintRow(6, String.Format("(目前候诊人数：{0}人)", WaitingNum), new Font("宋体", 16), System.Drawing.Brushes.Green, 170);
                        PrintRow srow7 = new PrintRow(7, "注意屏幕提示(过号重排)", new Font("宋体", 12), System.Drawing.Brushes.Black, 190);
                        PrintRow srow8 = new PrintRow(8, Time, new Font("宋体", 14), System.Drawing.Brushes.Black, 210);
                        Order tempOrders = new Order(new List<PrintRow>() { srow0, srow1, srow2, srow3, srow4, srow5, srow6, srow7, srow8});
